...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    if (zaman < 0 || zaman > 21600) return interaction.reply("<:metruscarpi:1212411181231247472>  | Süre limiti maksimum **6** saat olabilir.")
    const slowmode = Math.floor(zaman)
    interaction.channel.setRateLimitPerUser(slowmode)

   interaction.reply(`<:metrustik:1212410630317936700> | Yazma süre limiti **${zaman}** saniye olarak ayarlanmıştır.`)
