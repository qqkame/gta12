...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (ticketSystem && ticketSystemDate) {
            ...
            .setDescription(`<:metruscarpi:1212411181231247472>  | Bu sistem <t:${parseInt(ticketSystemDate.date / 1000)}:R> önce açılmış!`)
        
        return interaction.reply({ embeds: [date] })
        }

        const category = await guild.channels.create({
            name: 'AgentPhanter Ticket',
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:metrustik:1212410630317936700> | __**Destek Sistemi**__ başarıyla ayarlandı!\n\n<:kanal:1040649841996464139> Destek Kanalı: ${ticketkanal}\n<:kanal:1040649841996464139> Log Kanalı: ${logkanal}\n<:Bot:1212411993147834409> Yetkili Rolü: ${rol}`)
