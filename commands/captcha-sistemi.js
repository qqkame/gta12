...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (rcaptchaSystem && rcaptchaDate) {
            ...
            .setDescription(`<:metruscarpi:1212411181231247472>  | Bu sistem <t:${parseInt(rcaptchaDate.date / 1000)}:R> önce açılmış!`)
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:metrustik:1212410630317936700> | __**Captcha Sistemi**__ başarıyla ayarlandı!\n\n<:kanal:1040649841996464139> Captcha Kanalı: ${kanal}\n<:Bot:1212411993147834409> Captcha Rolü: ${rol}`)
