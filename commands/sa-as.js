...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    switch(saasSystemTrue) {
      case "ac": {
        if(saasSystem) return interaction.reply({ content: "<:metruscarpi:1212411181231247472>  | Bu sistem zaten açık!" });
      ...
      case "kapat": {
        if(!saasSystem) return interaction.reply({ content: "<:metruscarpi:1212411181231247472>  | Bu sistem zaten kapalı?" });
