...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (kayitSistemi && kayıtSistemiDate) {
            ...
            .setDescription(`<:metruscarpi:1212411181231247472>  | Bu sistem <t:${parseInt(kayıtSistemiDate.date / 1000)}:R> önce açılmış!`)
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:metrustik:1212410630317936700> | __**Kayıt Sistemi**__ başarıyla ayarlandı!\n\n<:kanal:1040649841996464139> Kayıt Kanalı: ${kayıtkanal}\n<:Bot:1212411993147834409> Kayıtlı Rolü: ${kayıtlırol}\n<:Bot:1212411993147834409> Kayıtsız Rolü: ${kayıtsızrol}`)
