...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (timeoutSistemi && timeoutSistemiDate) {
            ...
            .setDescription(`<:metruscarpi:1212411181231247472>  | Bu sistem <t:${parseInt(timeoutSistemiDate.date / 1000)}:R> önce açılmış!`)
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:metrustik:1212410630317936700> | __**Timeout Sistemi**__ başarıyla ayarlandı! __/timeout__ komutu ile sistemi kullanabilirsin.\n\n<:kanal:1040649841996464139> Log Kanalı: ${kanal}\n<:Bot:1212411993147834409> Yetkili Rolü: ${rol}`)
