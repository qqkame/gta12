...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (!interaction.member.roles.cache.has(db.fetch(`yetkili_${interaction.guild.id}`))) return interaction.reply(`<:metruscarpi:1212411181231247472>  | Bu komutu sadece ayarlanan **Mute Yetkilisi** rolü olan kişiler kullanabilir.`)
