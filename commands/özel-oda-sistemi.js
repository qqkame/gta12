...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    if (ozelOdaSystem && ozelOdaSystemDate) {
        ...
        .setDescription(`<:metruscarpi:1212411181231247472>  | Bu sistem <t:${parseInt(ozelOdaSystemDate.date / 1000)}:R> önce açılmış!`)
  ...
  const channel = await interaction.guild.channels.create({
    ...
    interaction.reply("<:metrustik:1212410630317936700> | Sesli Kanal Başarıyla Oluşturuldu.")
}
