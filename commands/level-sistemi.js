    ...
    switch(levelSystemTrue) {
      case "ac": {
        ...
        if (levelSystem && levelSystemDate) {
            ...
            .setDescription(`<:metruscarpi:1212411181231247472>  | Bu sistem <t:${parseInt(levelSystemDate.date / 1000)}:R> önce açılmış!`)
      ...
      case "kapat": {
        if(!levelSystem) return interaction.reply({ content: "<:metruscarpi:1212411181231247472>  | Bu sistem zaten kapalı?" });
