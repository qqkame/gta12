   ...
   switch(hesapkorumaSystemTrue) {
    case "ac": {
      ...
      if (hesapkorumaSystem && hesapkorumaSystemDate) {
          ...
          .setDescription(`<:metruscarpi:1212411181231247472>  | Bu sistem <t:${parseInt(hesapkorumaSystemDate.date / 1000)}:R> önce açılmış!`)
    ...
    case "kapat": {
      if(!hesapkorumaSystem) return interaction.reply({ content: "<:metruscarpi:1212411181231247472>  | Bu sistem zaten kapalı?" });
