...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const basarili = new Discord.EmbedBuilder()
            .setColor("Green")
            .setTitle("<:metrustik:1212410630317936700> | Başarıyla Ayarlandı!")
            .setDescription("<:metrustik:1212410630317936700> | Botlist sistemi başarıyla ayarlandı!")
            .setFooter({ text: "AgentPhanter" })


            const menu = new Discord.EmbedBuilder()
            .setColor("000000")
            .setTitle(":question: | Botumu Nasıl Eklerim?")
