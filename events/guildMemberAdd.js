      ...
      try {
        ...
        if(member.user.bot) {
            if(data) {
                ...
                .setTitle("<:metrustik:1212410630317936700> | Bot Onaylandı!")
            ...
            channel.send({
                content: `<@${member.user.id}>`, embeds: [
                    new Discord.EmbedBuilder()
                        ...
                        .setDescription('• Merhaba AgentPhanter kullanıcısı, seni sunucumuza güvenle alabilmek için altta bulunan yazıyı butona tıklayarak yazman gerekiyor.')
