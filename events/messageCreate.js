...
module.exports =  {
  ...
  message.delete()
  message.channel.send(`<:metruscarpi:1212411181231247472>  | Hey <@${message.author.id}>, Bu Sunucuda Küfür Engel Sistemi Aktif! `)
  }
  }
  ...
  if(linkler.some(alo => message.content.toLowerCase().includes(alo))) {
    ...
    if(message.author?.bot) return;
  message.delete()
  message.channel.send(`<:metruscarpi:1212411181231247472>  | Hey <@${message.author.id}>, Bu Sunucuda Reklam Engel Sistemi Aktif! `)
  }
  }
